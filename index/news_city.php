...
$q_cat = $mysqli->query("select city_name from cities where city_id='$city_id'");
...
<div class="container floated">
	...
	if(!isset($_GET['news_id'])){
		$q_max = $mysqli->query("select max(news_id) as new_id from news_city where city_id = '".abs((int)$_GET['city_id'])."' and active_status = '1'");
	...
	$query_pub = $mysqli->query("SELECT * FROM news_city where news_id = '$news_id'");
